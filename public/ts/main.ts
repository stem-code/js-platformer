...
var playerAppearance = {color:"#f00", playerSpriteSheetIndex:Math.floor(Math.random() * 1),  rgbColor: [255, 0, 0]};//rgbColor:[Math.floor(Math.random() * 256), Math.floor(Math.random() * 256), Math.floor(Math.random() * 256)]};
