class SpriteSheet {
    ...
    public widthPerSprite: number;
    public heightPerSprite: number;
    public numIndices: {numX:number, numY:number};

    constructor(originalImage: any, widthPerSprite: number, heightPerSprite: number) {
    ...
    drawSprite(ctx: any, xIndex: number, yIndex: number, x: number, y: number, width: number, height: number) {
